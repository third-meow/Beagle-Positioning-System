...
try:
	while(1):
		...
		print 'You are Tracking: ',myGPS.sats,' satellites'
                print 'My Latitude: ', myGPS.latDeg, ' Degrees, ', myGPS.latMin, ' minutes, ', ' In ', myGPS.latHem, 'Hemiphere'
                print 'My Longitude: ', myGPS.lonDeg, ' Degrees, ', myGPS.lonMin, ' minutes, ', ' In ', myGPS.lonHem, 'Hemiphere'
